...
<body class="bg-[#FDF3EC] text-gray-800">
    ...
    <nav class="sticky top-0 z-50 bg-white/90 backdrop-blur-md shadow-sm border-b border-amber-100">
        <div class="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
            <a href="#" class="flex items-center gap-2">
                <img src="images/rasa_nusantara_logo.png" alt="Rasa Nusantara" class="w-9 h-9 object-contain">
            ...
            <a href="https://wa.me/6281234567890?text=Halo%20Rasa%20Nusantara,%20saya%20ingin%20memesan%20menu."
    ...
    <section id="hero" class="max-w-7xl mx-auto px-6 py-16 md:py-24 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div class="relative">
            <img src="images/1.jpg" alt="Kuliner Nusantara" class="rounded-3xl shadow-2xl w-full object-cover h-[320px] md:h-[400px]">
        </div>
    </section>
        ...
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-amber-100 overflow-hidden hover:shadow-md transition">
                    <div class="relative">
                        <img src="images/menu/rendang.jpg" alt="Rendang Sapi" class="w-full h-48 object-cover">
                        <span class="absolute top-3 right-3 bg-red-600 text-white text-xs font-bold px-3 py-1 rounded-full">Spicy</span>
                    </div>
                    <div class="p-6">
                        <div class="flex justify-between items-start mb-2 gap-3">
                            <h3 class="font-display text-xl font-bold text-gray-900">Rendang Sapi</h3>
                            <span class="text-amber-700 font-extrabold whitespace-nowrap">Rp 45.000</span>
                        </div>
                        <p class="text-gray-600 text-sm mb-4 leading-relaxed line-clamp-2">Daging sapi empuk yang dimasak dengan santan dan rempah-rempah pilihan khas Minang.</p>
                        <a href="https://wa.me/6281234567890?text=Halo%20Rasa%20Nusantara,%20saya%20ingin%20memesan%20*Rendang%20Sapi*%20seharga%20Rp%2045.000."
                           target="_blank" rel="noopener"
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-amber-100 overflow-hidden hover:shadow-md transition">
                    <div class="relative">
                        <img src="images/menu/sate.jpg" alt="Sate Ayam Madura" class="w-full h-48 object-cover">
                        <span class="absolute top-3 right-3 bg-amber-900 text-white text-xs font-bold px-3 py-1 rounded-full">Favorit</span>
                    </div>
                    <div class="p-6">
                        <div class="flex justify-between items-start mb-2 gap-3">
                            <h3 class="font-display text-xl font-bold text-gray-900">Sate Ayam Madura</h3>
                            <span class="text-amber-700 font-extrabold whitespace-nowrap">Rp 35.000</span>
                        </div>
                        <p class="text-gray-600 text-sm mb-4 leading-relaxed line-clamp-2">Sate ayam dengan bumbu kacang kental gurih dan taburan bawang goreng renyah.</p>
                        <a href="https://wa.me/6281234567890?text=Halo%20Rasa%20Nusantara,%20saya%20ingin%20memesan%20*Sate%20Ayam%20Madura*%20seharga%20Rp%2035.000."
                           target="_blank" rel="noopener"
                           class="block text-center w-full bg-white hover:bg-amber-50 text-emerald-800 font-bold py-2.5 rounded-xl border border-amber-200 transition">
                            Pesan Sekarang
                        </a>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-amber-100 overflow-hidden hover:shadow-md transition">
                    <div class="relative">
                        <img src="images/menu/soto.jfif" alt="Soto Betawi" class="w-full h-48 object-cover">
                    </div>
                    <div class="p-6">
                        <div class="flex justify-between items-start mb-2 gap-3">
                            <h3 class="font-display text-xl font-bold text-gray-900">Soto Betawi</h3>
                            <span class="text-amber-700 font-extrabold whitespace-nowrap">Rp 40.000</span>
                        </div>
                        <p class="text-gray-600 text-sm mb-4 leading-relaxed line-clamp-2">Soto kuah santan dan susu yang gurih kaya rempah lengkap dengan potongan daging sapi empuk.</p>
                        <a href="https://wa.me/6281234567890?text=Halo%20Rasa%20Nusantara,%20saya%20ingin%20memesan%20*Soto%20Betawi*%20seharga%20Rp%2040.000."
                           target="_blank" rel="noopener"
                           class="block text-center w-full bg-white hover:bg-amber-50 text-emerald-800 font-bold py-2.5 rounded-xl border border-amber-200 transition">
                            Pesan Sekarang
                        </a>
    ...
    <footer id="contact" class="bg-[#F6C9BC] pt-16">
        <div class="max-w-7xl mx-auto px-6 pb-12 grid md:grid-cols-4 gap-10">
            <div>
                <div class="flex items-center gap-2 mb-3">
                    <img src="images/rasa_nusantara_logo.png" alt="Rasa Nusantara" class="w-8 h-8 object-contain">
        ...
        <div class="border-t border-black/10">
            <div class="max-w-7xl mx-auto px-6 py-6 text-center text-xs text-gray-700">
                &copy; 2026 Rasa Nusantara. Authentic Indonesian Taste.
            </div>
        </div>
    </footer>
